...
<details id="details-postProcessing-sceneIlluminationMixIn">
    ...
    static setupAllGlobalFilters() {
        ...
        try {
            ...
            systemStatus.update('shaders', 'prism', { state: 'ok', message: 'Compiled successfully.' });
        } catch (e) {
            console.error("MapShine | Failed to compile PrismFilter", e);
            systemStatus.update('shaders', 'prism', { state: 'error', message: `Compilation failed: ${e.message}` });
        }
        ...
        try { this.addFilter('vignette', new VignetteFilter()); } catch (e) { ppErrors.push('Vignette'); }
        try { this.addFilter('lensDistortion', new LensDistortionFilter()); } catch (e) { ppErrors.push('LensDistortion'); }
        try { this.addFilter('chromaticAberration', new ChromaticAberrationFilter()); } catch (e) { ppErrors.push('ChromaticAberration (Post)'); }
        try {
        ...
        } catch (e) { ppErrors.push('ColorCorrection'); }

...
class DebuggerEventHandler {
    ...
    updateAllControls() {
        ...
        // Update visibility of the world-based icons
...
class DebuggerUIBuilder {
    ...
    static _createAccordionHTML(id, title, content, headerExtra = '') {
        ...
        // Manually create the label and checkbox parts to have control over their placement.
        ...
        // Assemble the header with the label and icon grouped together.

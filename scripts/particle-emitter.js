  ...
  class SpeedBehavior {
    ...
    initParticles(first) {
      ...
      while (next) {
        ...
        next.config.speedMult = mult;
        if (!next.config.velocity) {
          next.config.velocity = new math.Point(
            this.list.first.value * mult,
            0
          );
        } else {
  ...
  function upgradeConfig(config, art) {
    ...
    if (
      ...
      if ("start" in config.speed) {
        minStart =
          config.speed.start *
          ((_a = config.speed.minimumSpeedMultiplier) !== null && _a !== void 0
            ? _a
            : 1);
        ...
        minStart =
          ...
          ((_b = config.minimumSpeedMultiplier) !== null && _b !== void 0
            ? _b
            : 1);
    ...
    // path movement
      ...
      (_c = config.extraData) === null || _c === void 0 ? void 0 : _c.path
    ) {
      let list;
      let mult;
      if ("start" in config.speed) {
        mult =
          (_d = config.speed.minimumSpeedMultiplier) !== null && _d !== void 0
            ? _d
            : 1;
        ...
        list = config.speed;
        mult =
          (_e = config.minimumSpeedMultiplier) !== null && _e !== void 0
            ? _e
            : 1;
      }
      out.behaviors.push({
        ...
        if ("start" in config.speed) {
          if (config.speed.start === config.speed.end) {
            out.behaviors.push({
              ...
              config: {
                min:
                  config.speed.start *
                  ((_f = config.speed.minimumSpeedMultiplier) !== null &&
                  _f !== void 0
                    ? _f
                    : 1),
          ...
          out.behaviors.push({
            ...
            config: {
              min:
                config.speed.list[0].value *
                ((_g = config.minimumSpeedMultiplier) !== null && _g !== void 0
                  ? _g
                  : 1),
          ...
          out.behaviors.push({
            ...
            config: {
              speed: config.speed,
              minMult:
                (_h = config.minimumSpeedMultiplier) !== null && _h !== void 0
                  ? _h
                  : 1,
            },
          });
    ...
    if (config.scale) {
      if ("start" in config.scale) {
        const mult =
          (_j = config.scale.minimumScaleMultiplier) !== null && _j !== void 0
            ? _j
            : 1;
        ...
        const mult =
          (_k = config.minimumScaleMultiplier) !== null && _k !== void 0
            ? _k
            : 1;
        ...
        out.behaviors.push({
          ...
          config: {
            scale: config.scale,
            minMult:
              (_l = config.minimumScaleMultiplier) !== null && _l !== void 0
                ? _l
                : 1,
          },
        });
    ...
    if (
      ...
      ((_m = config.rotationSpeed) === null || _m === void 0
        ? void 0
        : _m.min) ||
      ...
      out.behaviors.push({
        ...
        config: {
          ...
          minSpeed:
            ((_p = config.rotationSpeed) === null || _p === void 0
              ? void 0
              : _p.min) || 0,
          maxSpeed:
            ((_q = config.rotationSpeed) === null || _q === void 0
              ? void 0
              : _q.max) || 0,
          minStart:
            ((_r = config.startRotation) === null || _r === void 0
              ? void 0
              : _r.min) || 0,
          maxStart:
            ((_s = config.startRotation) === null || _s === void 0
              ? void 0
              : _s.max) || 0,
        },
      });
    } else if (
      ((_t = config.startRotation) === null || _t === void 0
        ? void 0
        : _t.min) ||
      ...
      out.behaviors.push({
        ...
        config: {
          min:
            ((_v = config.startRotation) === null || _v === void 0
              ? void 0
              : _v.min) || 0,
          max:
            ((_w = config.startRotation) === null || _w === void 0
              ? void 0
              : _w.max) || 0,
        },
      });
  ...
  class LinkedListContainer extends display.Container {
    ...
    addChildAt(child, index) {
      if (index < 0 || index > this._childCount) {
        throw new Error(
          `addChildAt: The index ${index} supplied is out of bounds ${this._childCount}`
        );
      }
      if (child.parent) {
        child.parent.removeChild(child);
    ...
    setChildIndex(child, index) {
      if (index < 0 || index >= this._childCount) {
        throw new Error(
          `The index ${index} supplied is out of bounds ${this._childCount}`
        );
      }
    ...
    getLocalBounds(rect, skipChildrenUpdate = false) {
      ...
      const result = display.DisplayObject.prototype.getLocalBounds.call(
        this,
        rect
      );

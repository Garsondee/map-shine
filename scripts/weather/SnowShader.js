/**
 * Snow shader effect with 20 layers of procedural snowflakes
 * Ported from Foundry VTT's SnowShader
 */
import { WeatherShaderBase } from './WeatherShaderBase.js';

export class SnowShader extends WeatherShaderBase {
  
  /**
   * Default uniform values for snow
   */
  ...
  /**
   * Fragment shader for snow effect
   */
